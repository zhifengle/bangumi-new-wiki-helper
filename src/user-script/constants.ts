...
export const AUTO_FILL_FORM = SCRIPT_PREFIX + 'autofill';
export const WIKI_DATA = SCRIPT_PREFIX + 'wiki_data';
export const CHARA_DATA = SCRIPT_PREFIX + 'chara_data';
export const PERSON_DATA = SCRIPT_PREFIX + 'person_data';
